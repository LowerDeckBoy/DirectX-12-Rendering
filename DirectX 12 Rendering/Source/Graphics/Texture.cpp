...
Texture::Texture(Device* pDevice, const std::string& TexturePath)
{
	...
	{
		CreateDDS(pDevice, TexturePath);
	}
	else
	{
		CreateWIC(pDevice, TexturePath);
	}
}
...
void Texture::CreateWIC(Device* pDevice, const std::string& TexturePath)
{
	assert(m_Device = pDevice);
...
void Texture::CreateDDS(Device* pDevice, const std::string& TexturePath)
{
	assert(m_Device = pDevice);
